...
initMap:- 
	addSolidObject('#'), 
	createGameEntity(OID, 'l', object, 1, 2, inactive, norule, 
	                 data(derringer, not_solid, not_static, gunBasic, 'Pistola derringer con 1 sólo disparo. Úsala bien.')),
	createGameEntity('E', mortal, 1, 6, inactive, norule, 0),
	entityType(EID_P, pacman),
	getObjectFrom(EID_P, 1, 2),
	createGameEntity('#', object, 2, 1, active, destroyRule,
